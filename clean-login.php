<?php
/**
 * @package Clean_Login Ex
 * @version 1.9.3
 */
/*
Plugin Name: Clean Login Ex
Plugin URI: https://github.com/fhdk/clean-login-ex
...
function clean_login_load_before_headers() {
	...
	if ( is_singular() ) {
		...
		if ( $post && strpos($post->post_content, 'clean-login' ) !== false ) {
			...
			// fhdk added redir variable - depending on WP_Session
